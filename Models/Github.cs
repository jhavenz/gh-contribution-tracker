...
namespace GitHubIssueTracker.Models
{
    public class GitHubIssue
    {
        ...
        public required GitHubUser Author { get; set; }
        ...
        public required List<GitHubUser> Assignees { get; set; }

        [JsonPropertyName("labels")]
        public required List<GitHubLabel> Labels { get; set; }
    ...
    public class GitHubRepository
    {
        ...
        [Key] // Explicitly mark NameWithOwner as Primary Key
